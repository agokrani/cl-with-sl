...
#SBATCH --output=logs/owl-recursive-%j.out
#SBATCH --error=logs/owl-recursive-%j.err
#SBATCH --job-name=owl-recursive
...
# Reduce CUDA fragmentation across the alternating finetune(unsloth)/eval(vLLM) cycles.

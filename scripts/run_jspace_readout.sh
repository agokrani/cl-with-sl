...
#SBATCH --mem=64G
#SBATCH --time=4:00:00
#SBATCH --job-name=jspace-readout
#SBATCH --output=logs/jspace-readout-%j.out
#SBATCH --error=logs/jspace-readout-%j.err
...
python scripts/run_jspace_readout.py "${EXTRA_LOCAL_ARGS[@]}" "$@"

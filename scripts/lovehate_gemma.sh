...
#SBATCH --job-name=lovehate-gemma
...
# PIN transformers to 5.14.1 -- 5.15.0 added a heterogeneous-config guard that
# breaks vLLM's Gemma-4 loader (AmbiguousGlobalPerLayerAttributeError). 5.14.1
# is the version that successfully trained + evaluated Gemma-4-12B on Aug 9.
